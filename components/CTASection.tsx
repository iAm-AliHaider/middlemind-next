  ...
  return (
    <section className="py-32 bg-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-widest text-purple-300 mb-6">Get started</p>
          <h2 className="font-heading text-5xl font-extrabold tracking-tight text-white sm:text-6xl">
            Have an idea?<br />
            <span className="text-purple-300">We&apos;ll build it.</span>
          </h2>
          ...
          <button
            ...
            className="mt-10 inline-flex items-center gap-3 rounded-full bg-white px-8 py-4 text-base font-semibold text-gray-900 hover:bg-gray-100 transition-colors shadow-xl"
          >
