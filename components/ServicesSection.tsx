...
export default function ServicesSection() {
  return (
    <section id="services" className="py-32 bg-[#0a0a0f]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <span className="inline-block rounded-full border border-teal/30 bg-teal/10 px-4 py-1.5 text-xs font-medium text-teal mb-6">
            Capabilities
          </span>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
            Six core capabilities. Infinite combinations. We select and compose the right 
            approach for every challenge.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group rounded-2xl bg-[#0f0f14] p-8 border border-white/5 hover:border-purple/30 transition-all"
            >
              <div className="mb-6 p-3 rounded-xl bg-purple/10 w-fit group-hover:bg-purple/20 transition-colors">
                {service.icon}
              </div>
