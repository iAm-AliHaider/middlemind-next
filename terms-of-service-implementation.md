# دليل تنفيذ شروط الاستخدام لمايا

## نظرة عامة
هذا الدليل يوضح كيفية تنفيذ صفحة شروط الاستخدام لمايا باستخدام Next.js 15 App Router. الصفحة ستكون متوفرة باللغة العربية مع دعم RTL.
...
export const metadata: Metadata = {
  title: 'شروط الاستخدام | مايا',
  description: 'شروط استخدام منصة مايا - المنصة الذكية للاستشارات التجارية',
};
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-lg max-w-none text-right" dir="rtl">
          ...
          <p className="mb-6">
            مرحباً بك في <strong>مايا (Maya)</strong>، المنصة الذكية للاستشارات التجارية من MiddleMind. هذه الشروط والأحكام ("الشروط") تحكم استخدامك لمنصة مايا وخدماتها. باستخدام مايا، أنت توافق على الالتزام بهذه الشروط.
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mt-8">
            ...
            <ul className="list-disc list-inside mt-2">
              <li>البريد الإلكتروني: support@middlemind.ai</li>
...
```bash
git add .
git commit -m "feat: add PDPL-compliant Terms of Service page for Maya"
git push origin master
```

## ملاحظات قانونية
- هذه الشروط مكتوبة باللغة العربية للتوافق مع PDPL
- تأكد من مراجعة المحتوى مع محامٍ سعودي قبل النشر
- أضف تاريخ السريان وإشعارات التعديل كما هو مطلوب

## توافق PDPL
هذه التنفيذ تضمن الامتثال للمتطلبات القانونية السعودية من خلال:
- اللغة العربية
- الإشارة إلى القوانين السعودية
- حقوق المستخدمين